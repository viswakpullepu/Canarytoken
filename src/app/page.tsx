    ...
    <div className="min-h-screen bg-[#030712] text-neutral-200 font-sans selection:bg-cyan-500/30 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto p-6 lg:p-12 relative z-10 space-y-10">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-white/5">
          ...
          <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md border border-white/5 px-4 py-2 rounded-full shadow-inner">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="xl:col-span-4 space-y-6">
            <div className="bg-white/[0.02] backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-white/20 transition-all duration-500">
              ...
              <form onSubmit={handleGenerateToken} className="space-y-5 relative z-10">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full relative group overflow-hidden bg-white/5 border border-white/10 hover:border-cyan-500/50 text-white font-semibold py-3.5 px-4 rounded-xl transition-all duration-300 mt-4 shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:shadow-[0_0_30px_rgba(6,182,212,0.3)]"
                >
              ...
              {/* Generated URL Display with Slide-down animation */}
              <div className={`transition-all duration-500 ease-out overflow-hidden ${generatedUrl ? 'max-h-48 mt-8 opacity-100' : 'max-h-0 mt-0 opacity-0'}`}>
          ...
          <div className="xl:col-span-8">
            <div className="bg-white/[0.02] backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl h-full flex flex-col relative">
              <div className="flex items-center justify-between mb-8">
                ...
                {alerts.length > 0 && (
                  <div className="flex items-center gap-2 text-xs font-medium text-neutral-400 bg-black/40 px-3 py-1.5 rounded-full border border-white/5">
              ...
              <div className="flex-1 overflow-y-auto max-h-[700px] pr-3 custom-scrollbar">
                {alerts.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-neutral-500 space-y-4 py-20 bg-black/20 rounded-2xl border border-white/5 border-dashed">
                    <div className="relative">
                  ...
                  <div className="space-y-4">
                    {alerts.map((alert, idx) => (
                      <div 
                        key={alert.id} 
                        className="bg-black/40 border border-white/5 hover:border-red-500/30 rounded-2xl p-5 relative overflow-hidden group transition-all duration-300 hover:shadow-[0_0_20px_rgba(239,68,68,0.05)] hover:-translate-y-0.5"
